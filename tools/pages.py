  ...
  body="""    <section class="page-hero">
    ...
    <section class="section">
      <div class="narrow prose">
        ...
        <p>Les polices de caractères sont chargées depuis Google Fonts, ce qui transmet votre adresse IP à Google lors du chargement. Les commandes vocales du mode accompagnement utilisent la reconnaissance vocale de votre navigateur, qui peut s'appuyer sur un service en ligne de son éditeur.</p>
